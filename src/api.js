...
// Fix folder methods to use the api instance with correct paths
const getFolders = () => api.get('/api/folders');
const createFolder = (data) => api.post('/api/folders', data);
const updateFolder = (id, data) => api.put(`/api/folders/${id}`, data);
const deleteFolder = (id) => api.delete(`/api/folders/${id}`);
const moveQuizToFolder = (folderId, data) => api.put(`/api/folders/${folderId}/move-quiz`, data);
...
export default {
  ...
  submitAnswer(answerData) {
    return api.post('/answers/submit', answerData);
  },
  ...
  deleteAnswer(answerId) {
    return api.delete(`/answers/${answerId}/delete`);
  },
